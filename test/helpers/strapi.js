...
/**
 * Grants database `permissions` table that
 * role can access an endpoint/controllers
 *
 * @param {int} roleID, 1 Autentihected, 2 Public, etc
 * @param {string} value, in form or dot string
 * eg `"permissions.users-permissions.controllers.auth.changepassword"`
 ...
 * @example
 *
 * const response =  {"statusCode":400,"error":"Bad Request","message":
 * \[{"messages":[{"id":"Auth.form.error.confirmed","message":"Your account
 *  email is not confirmed"}]}],"data":[{"messages":[{"id":"Auth.form.error.
 * confirmed","message":"Your account email is not confirmed"}]}]}
